...
//
//public class DartObjectConverter {
//
//    /**
//     * 转换多个对象
//     *
...
//                        map.put("__dart_object_type__", "function");
//                        map.put("__dart_object_ref__", jsValue.toObject().property("__dart_lobject_function_id__").toString());
//                        value = map;
//                    } else {
...
//                Map<String, Object> map = new HashMap<>();
//                map.put("__dart_object_type__", "exception");
