...
///    sheets can be created and displayed with the [showModalBottomSheetKeyBoard]
///    function.
///
/// The [BottomSheet] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] or
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showModalBottomSheetKeyBoard].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showModalBottomSheetKeyBoard], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showModalBottomSheetKeyBoard], for modal bottom sheets.
  const BottomSheet({
    Key key,
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  Color get barrierColor =>
      modalBarrierColor ?? Color.fromRGBO(255, 255, 255, 0);
...
///
/// This example demonstrates how to use `showModalBottomSheetKeyBoard` to display a
...
///   return Center(
///     child: RaisedButton(
///       child: const Text('showModalBottomSheetKeyBoard'),
///       onPressed: () {
///         showModalBottomSheetKeyBoard<void>(
///           context: context,
...
///    function passed as the `builder` argument to [showModalBottomSheetKeyBoard].
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal bottom sheets.
///  * [DraggableScrollableSheet], which allows you to create a bottom sheet
///    that grows and then becomes scrollable once it reaches its maximum size.
///  * <https://material.io/design/components/sheets-bottom.html#modal-bottom-sheet>
Future<T> showModalBottomSheetKeyBoard<T>({
...
/// [showModalBottomSheetKeyBoard] function.
///
