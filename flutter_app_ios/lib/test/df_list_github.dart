...
class DFList extends StatefulWidget {
  ...
  @override
  _DFListState createState() => _DFListState(finishedText,errorText);
}

class _DFListState extends State<DFList> {
  String finishedText;
  String errorText;

  _DFListState(this.finishedText, this.errorText);

  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate =>
      widget.delegate ?? DFList.buildDelegate();
    ...
    return NotificationListener<_RetryNotify>(
      child: NotificationListener<_BuildNotify>(
        child: DefaultLoadMoreView(
          ...
          errorText: errorText,
          textBuilder: widget.textBuilder ?? DFList.buildTextBuilder(),
        ),
...
class DefaultLoadMoreView extends StatefulWidget {
  ...
  @override
  DefaultLoadMoreViewState createState() => DefaultLoadMoreViewState(finishedText,errorText);
}
...
class DefaultLoadMoreViewState extends State<DefaultLoadMoreView> {
  ...
  DefaultLoadMoreViewState(this.finishedText, this.errorText);
...
abstract class LoadMoreDelegate {
  ...
  Widget buildChild(LoadMoreStatus status,String finishedText,String errorText,
...
class DefaultLoadMoreDelegate extends LoadMoreDelegate {
  ...
  Widget buildChild(LoadMoreStatus status,String finishedText,String errorText,
      {LoadMoreTextBuilder builder = DefaultLoadMoreTextBuilder.chinese}) {
    String text = builder(status,finishedText,errorText);
    if (status == LoadMoreStatus.fail) {
      return Container(
        child: Text(text),
      );
...
typedef String LoadMoreTextBuilder(LoadMoreStatus status,String finishedText,String errorText);

String _buildChineseText(LoadMoreStatus status,String finishedText,String errorText) {
  String text;
  switch (status) {
...
String _buildEnglishText(LoadMoreStatus status,String finishedText,String errorText) {
  String text;
  switch (status) {
    case LoadMoreStatus.fail:
